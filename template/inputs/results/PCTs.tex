...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../src/Poli/data/output.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[H]{0.15\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../src/Poli/data/supplementary/frame-2.png}
        \\ (a) $t=1$
    \end{minipage}
    \hfill
    \begin{minipage}[H]{0.15\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../src/Poli/data/supplementary/frame-3.png}
        \\ (b) $t=5$
    \end{minipage}
    \hfill
    \begin{minipage}[H]{0.15\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../src/Poli/data/supplementary/frame-4.png}
        \\ (c) $t=10$
    \end{minipage}
