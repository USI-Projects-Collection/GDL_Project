...
\begin{figure}[H]
    ...
    \caption{Accuracy retention plot over rollout steps, comparing Baseline, MP, and GRF models. This plot successfully reproduces the relative model ranking (GRF $>$ MP $>$ Baseline) observed in Figure 4 (\textit{"Accuracy vs. rollout timestep"}) of the original paper \cite{reid2025linear}, while utilizing our geometric \texttt{ACCURACY\_THRESHOLD} metric.}
