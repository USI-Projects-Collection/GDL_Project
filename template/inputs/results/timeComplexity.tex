...
The results of our replication confirms the time complexity claims made in the original paper. Figure \ref{fig:1} plots the calculated FLOPs (scaled by $10^6$) against the number of graph nodes $N$ on a log-log scale.
\begin{figure}[H]
    \centering
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccc}
        ...
        8 (Crossover) & $\mathbf{2.05 \times 10^{-3}}$ & $\mathbf{2.05 \times 10^{-3}}$ & $6.48 \times 10^{-3}$ \\
        64 & $1.31 \times 10^{-1}$ & $1.64 \times 10^{-2}$ & $5.38 \times 10^{-2}$ \\
        512 & $8.39 \times 10^{0}$ & $1.31 \times 10^{-1}$ & $4.11 \times 10^{-1}$ \\
        4096 & $\mathbf{5.37 \times 10^{2}}$ & $\mathbf{1.05 \times 10^{0}}$ & $\mathbf{3.30 \times 10^{0}}$ \\
        \bottomrule
    \end{tabular}
    }
